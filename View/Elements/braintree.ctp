...
<div class="new-payment-fields">
    ...
    <div class="row">
    	<div class="col-sm-4">
    		<?php echo $this->Form->input('brainTree.creditCard.month', array('label' => 'Expiration Month', 'type' => 'select', 'options' => array_combine(range(1, 12, 1), range(1, 12, 1)))); ?>
    	</div>
    	<div class="col-sm-4">
    		<?php echo $this->Form->input('brainTree.creditCard.year', array('class' => 'required', 'label' => 'Exp Year', 'type' => 'select', 'options' => array_combine(range(date('Y'), date('Y', strtotime('+ 10 years')), 1), range(date('Y'), date('Y', strtotime('+ 10 years')), 1)), 'dateFormat' => 'Y')); ?>
    	</div>
    	<div class="col-sm-4">
