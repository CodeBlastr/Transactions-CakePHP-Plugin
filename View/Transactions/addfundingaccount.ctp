...
<?php if (empty($merchantId)): ?>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td><?php echo $this->Form->input('merchant.id', array('label' => false, 'div' => false, 'type' => 'text', 'required' => 'required', 'placeholder' => 'choose you desired id, a-z only', 'autocomplete' => 'off', 'class' => 'form-control')); ?></td>
        </tr>
        <tr>
