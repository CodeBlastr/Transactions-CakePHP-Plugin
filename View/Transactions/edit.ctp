<div class="invoice form"> <?php echo $this->Form->create('Transaction');?>
  <fieldset>
    <?php
		echo $this->Form->hidden('Transaction.id');
		echo $this->Form->hidden('Transaction.status');
		if (!empty($this->request->params['named']['contact_id'])) {
			echo $this->Form->input('Transaction.contact_id', array('type' => 'hidden', 'value' => $this->request->params['named']['contact_id']));
		} else {
			...
			echo $this->Form->input('Transaction.contact_id', array(
				'empty' => '-- Optional --',
		...
		echo $this->Form->input('Transaction.number', array('label' => 'Transaction Number'));
		echo $this->Form->input('Transaction.po_number', array('label' => 'PO Number'));
  ...
  <div class="invoiceTotal">
    <ul id="totals">
      <li><?php echo $this->Form->input('Transaction.total', array('label' => 'Transaction Total', 'div' => false)); ?></li>
      <li><?php echo $this->Form->input('Transaction.balance', array('label' => 'Transaction Balance', 'div' => false)); ?></li>
    </ul>
  </div>
  <fieldset>
    <legend>
    ...
    <?php
		echo $this->Form->input('Transaction.introduction', array('label' => 'Notes to client', 'class'=>'span5', 'div' => array('class'=>'span5')));
		echo $this->Form->input('Transaction.conclusion', array('label' => 'Terms', 'class'=>'span5', 'div' => array('class'=>'span5')));
	?>
  </fieldset>
